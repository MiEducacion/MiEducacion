...
class SiteSettings < RailsSettings::Base
  ...
  scope :application do
    ...
    field :developer_emails,
          default: (ENV['MIEDUCACION_DEVELOPER_EMAILS'] || ['developer@mieducacion.net', 'installer@mieducacion.net']), type: :array, readonly: true
  ...
  scope :client_side do
    ...
    field :site_title, default: (ENV['MIEDUCACION_SITE_TITLE'] || 'MiEducación'),
                       validates: { presence: true, length: { in: 2..255 } }
    field :site_logo, default: (ENV['MIEDUCACION_SITE_LOGO'] || '/images/default/mieducacion_default_siteLogo.svg'),
                      type: :string
    field :app_icon, default: (ENV['MIEDUCACION_APP_ICON'] || '/images/default/mieducacion_default_appicon.png'),
                     type: :string
